...
!function ($) {
    ...
    $.niftyNoty = function(options){
        var defaults = {
            ...
            onShown     : function(){},
            // This event is fired when the modal has been made visible to the sysuser (will wait for CSS transitions to complete).

            onHide      : function(){},
            // This event is fired immediately when the hide instance method has been called.

            onHidden    : function(){}
            // This event is fired when the notification has finished being hidden from the sysuser (will wait for CSS transitions to complete).
