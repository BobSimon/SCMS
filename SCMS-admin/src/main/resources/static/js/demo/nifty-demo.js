// Nifty-demo.js
// ====================================================================
// Set sysuser options for current page.
        ...
        function InitializeSettingWindow(){
            ...
            boxedLayoutCheckbox.onchange = function(){
                if (boxedLayoutCheckbox.checked) {
                    ...
                    document.getElementById('demo-asd-fixed').checked = false;
                    //change iframe scale
                    iframeInit.removeClass('embed-responsive-16by9');
                    iframeInit.addClass('embed-responsive-4by3');
                    boxedLayoutImgBtn.disabled = false;
                } else {
                    niftyContainer.removeClass('boxed-layout').removeAttr( 'style' );
                    niftyContainer.removeClass('aside-fixed');
                    document.getElementById('demo-asd-fixed').checked = true;
                    iframeInit.removeClass('embed-responsive-4by3');
                    iframeInit.addClass('embed-responsive-16by9');
                    boxedLayoutImgBtn.disabled = true;
