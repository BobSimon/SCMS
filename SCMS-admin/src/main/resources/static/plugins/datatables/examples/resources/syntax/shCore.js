...
/**
 * Unindents a block of text by the lowest base indent amount.
...
function unindent(str)
{
    ...
    // go through every line and check for base number of indents
    ...
    // trim minimum base number of white space from the begining of every line
    if (min > 0)
        for (var i = 0, l = lines.length; i < l; i++)
...
function processUrls(code)
{
    ...
    return code.replace(sh.regexLib.url, function(m)
    {
        ...
        // We include &lt; and &gt; in the URL for the base cases like <http://google.com>
...
sh.Highlighter.prototype = {
    ...
    getHtml: function(code)
    {
        ...
        // unindent code by the base indentation
...
;(function()
{
    ...
    function Brush()
    {
        ...
        this.regexList = [
            ...
            { regex: new RegExp(this.getKeywords(funcs), 'gmi'),        css: 'functions' },         // base functions
