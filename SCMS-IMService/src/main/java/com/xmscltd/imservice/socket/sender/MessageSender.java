package com.xmscltd.imservice.socket.sender;



import com.xmscltd.imservice.model.SocketUser;
import com.xmscltd.imservice.model.message.ToClientTextMessage;
import com.xmscltd.imservice.model.message.ToDBMessage;
import com.xmscltd.imservice.model.message.ToServerMessageMine;
import com.xmscltd.imservice.model.message.ToServerTextMessage;
import com.xmscltd.imservice.model.result.ToClientMessageResult;
import com.xmscltd.imservice.model.result.ToClientMessageType;
import com.xmscltd.imservice.socket.LayIMChatType;
import com.xmscltd.imservice.socket.LayIMFactory;
...
public class MessageSender {
    ...
    public void sendMessage(ToServerTextMessage message){
        ...
        if(type.equals(LayIMChatType.GROUP)){
            ...
            List<String> users =  LayIMFactory.createGroupUserManager().getGroupMembers(message.getTo().getId());
...
//            LayIMLog.info("该用户不在线 ");
    ...
    private void saveMessage(ToServerTextMessage message){
        ...
        dbMessage.setAddtime(System.currentTimeMillis());
